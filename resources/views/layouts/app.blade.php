    ...
    <div class="d-flex" id="wrapper">
        <div class="border-end" id="sidebar-wrapper">
            <div class="sidebar-heading text-center">
                <img src="{{ asset('images/logo_despapela.png') }}" alt="Logo Despapela" style="height: 40px;">
            </div>
            <div class="list-group list-group-flush">
                ...
                @can('view-signature-inbox')
                     <a href="{{ route('signatures.index') }}" class="list-group-item list-group-item-action {{ request()->routeIs('signatures.index') || request()->routeIs('signatures.show') ? 'active' : '' }}">
                         <i class="fas fa-file-signature fa-fw me-3"></i><span>Documentos para Firmar</span>
                     </a>
                @endcan

                @can('view-signed-documents')
                     <a href="{{ route('signed.index') }}" class="list-group-item list-group-item-action {{ request()->routeIs('signed.index') ? 'active' : '' }}">
                         <i class="fas fa-check-circle fa-fw me-3"></i><span>Documentos Firmados</span>
                     </a>
                @endcan

                @can('view-archived-documents')
                    <a href="{{ route('documents.archived') }}" class="list-group-item list-group-item-action {{ request()->routeIs('documents.archived') ? 'active' : '' }}">
                        <i class="fas fa-archive fa-fw me-3"></i><span>Documentos Archivados</span>
                    </a>
                @endcan
            </div>
        </div>
